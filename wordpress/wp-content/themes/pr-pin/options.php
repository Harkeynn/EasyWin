...
$options[] = array( "name" => __('Info','prpin'),
		"desc" =>  __('Available only for Premium Pin version','prpin'),
	    	"type" => "info");
...
$options[] = array( 'name' => __(' ','prpin'),
	"desc" =>  __('<h3><a id="support"   title="Support" href="http://www.premiumresponsive.com/support/" target="_blank">Support</a>   &nbsp; &nbsp;  <a id="demo" title="Demo / Documentation" href="http://pin.premiumresponsive.com/" target="_blank">Demo / Documentation</a></h3>','prpin'),
	    	"type" => "info");
